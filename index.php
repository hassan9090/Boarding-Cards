<?php
   ...
   */
   echo PHP_EOL . 'Boarding Cards Test' . PHP_EOL;
   ...
   */
  use \boardingcards\assets\CardFactory;
  use \boardingcards\assets\CardAbstract;
  use \boardingcards\assets\transportable\Person;
  use \boardingcards\assets\TransportableAbstract;
  use \boardingcards\modules\trip\Trip;
  
  /**
   * $passenger could be an instance of Person or an array which contains Person instances.
   */
  ...
  /**
   * Create a Trip class and sort boarding cards.
